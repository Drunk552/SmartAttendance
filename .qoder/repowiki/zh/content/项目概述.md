...
### T9键盘集成
- T9键盘支持：4x4硬件键盘映射，支持数字、英文、中文、符号四种输入模式。
- 输入法切换：通过#键循环切换输入模式，支持候选词选择与导航。
- LVGL集成：提供完整的UI组件与事件处理，支持在员工注册、查询等界面使用。

**章节来源**
- [T9键盘集成指南.md:1-358](file://docs/markdowm/T9键盘集成指南.md#L1-L358)
...
- 项目特点：模块化设计、多模态认证、规则引擎、报表导出、实时监控与预处理、T9键盘输入。
