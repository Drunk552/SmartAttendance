...
```mermaid
graph TB
A["应用入口<br/>src/main.cpp"] --> B["UI 层<br/>src/ui/ui_app.c"]
...
- [ui_app.c:308-336](file://src/ui/ui_app.c#L308-L336)
...
participant UI as "UI 层<br/>ui_app.c"
...
- [lv_conf.h:29-110](file://lv_conf.h#L29-L110)
- [CMakeLists.txt:52-71](file://CMakeLists.txt#L52-L71)
- [ui_app.c:43-57](file://src/ui/ui_app.c#L43-L57)
