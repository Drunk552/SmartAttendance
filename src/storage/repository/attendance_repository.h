/**
 * @file attendance_repository.h
 * @brief 声明考勤规则读取与考勤记录持久化抽象。
 */

#ifndef SMART_ATTENDANCE_STORAGE_REPOSITORY_ATTENDANCE_REPOSITORY_H
#define SMART_ATTENDANCE_STORAGE_REPOSITORY_ATTENDANCE_REPOSITORY_H
...
struct AttendanceEntry {
    ...
    /** @brief 可选 JPEG 抓拍；Repository 必须在 save 返回前完成消费。 */
...
#endif // SMART_ATTENDANCE_STORAGE_REPOSITORY_ATTENDANCE_REPOSITORY_H
